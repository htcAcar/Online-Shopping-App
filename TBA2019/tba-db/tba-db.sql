...
INSERT INTO `carts` (`product_ID`, `customer_ID`, `category`) VALUES
(15, 1, 'television'),
(3, 1, 'phone');
...
(3, 'asma.aiouez@gmail.com', 'password123', '1994-01-01', 'Ankara, Turkey.', 0);
...
INSERT INTO `favorites` (`customer_ID`, `product_ID`, `category`) VALUES
(3, 13, 'headphone'),
(3, 12, 'television');
...
(5, 'Sony MDR-ZX110', 'black', 'sony', '125cm', 50),
(6, 'Philips SHL5000', 'white', 'Philips', '120cm', 60),
(7, 'Philips SHL3075BL', 'pink', 'Philips', '130', 70),
(8, 'Sony MDR-ZX310', 'green', 'sony', '120cm', 56);
...
(1, 'Samsung Galaxy J8', 'black', '5.7', 'Samsung', '4GB', '16MP', 2000),
(2, ' Huawei Honor 10 lite', 'white', '6.21', 'Huawei', '3GB', '13MP', 1700),
(3, 'Samsung Galaxy A30', 'blue', '6.1', 'Samsung', '4GB', '13MP', 1500),
(4, 'iPhone 6S 16GB', 'pink', '5.5', 'Apple', '4GB', '16MP', 7000);
...
INSERT INTO `products` (`product_ID`, `seller_ID`, `category`, `count`) VALUES
(1, 1, 'phone', 2),
(2, 1, 'phone', 2),
(3, 1, 'phone', 2),
(4, 1, 'phone', 2),
...
INSERT INTO `reviews` (`customer_ID`, `product_ID`, `review`) VALUES
(2, 16, 'I like it'),
(1, 11, 'good'),
(1, 8, 'deneme'),
(1, 7, 'Nice');
