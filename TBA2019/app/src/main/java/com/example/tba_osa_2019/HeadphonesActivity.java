...
public class HeadphonesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new HeadphonesActivity.FetchHeadphonesAsyncTask().execute();
    }
    ...
    private class FetchHeadphonesAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(HeadphonesActivity.this);
    ...
    private void populatePhoneList() {
        ...
        ListAdapter adapter = new SimpleAdapter(
                HeadphonesActivity.this, headphoneList,
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),
                            HeadphoneActivityDetail.class);
                    intent.putExtra(KEY_PRODUCT_ID, phoneId);
                    startActivityForResult(intent, 20);

                } else {
                    Toast.makeText(HeadphonesActivity.this,
