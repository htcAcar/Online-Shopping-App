...
public class AddHeadphoneActivity extends AppCompatActivity {
    ...
    private TextView cableTextView;
    private EditText cableEditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_headphone);

        Intent intent = getIntent();

        addHeadphone = (TextView) findViewById(R.id.addTvTextView);

        nameTextView = (TextView) findViewById(R.id.nameTextView);
        brandTextView = (TextView) findViewById(R.id.brandTextView);
        colorTextView = (TextView) findViewById(R.id.colorTextView);
        cableTextView = (TextView) findViewById(R.id.cableTextView);
        ...
        cableEditText = (EditText) findViewById(R.id.cableEditText);
        cableEditText.setBackgroundResource(R.drawable.button_border);

        priceEditText = (EditText) findViewById(R.id.priceEditText);
        priceEditText.setBackgroundResource(R.drawable.button_border);

        addButton2 = (Button) findViewById(R.id.addButtonTV);
        addButton2.setBackgroundResource(R.drawable.button_border);
        addButton2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(AddHeadphoneActivity.this,
    ...
    public void setProductDetails()
    {
        ...
        cableLength = cableEditText.getText().toString();
    ...
    private class SetNewProductAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(AddHeadphoneActivity.this);
        ...
        protected String doInBackground(String... params) {
            ...
            httpParams.put(KEY_CABLE_LENGTH, cableLength);
            httpParams.put(KEY_PRICE, priceAdd+"");
            httpParams.put(KEY_SELLER_ID, sellerID+"");
            JSONObject jsonObject = httpJsonParser.makeHttpRequest(
                    BASE_URL + "products/headphone/add_headphone.php", "GET", httpParams);
