...
public class PhonesActivityGuest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_phones_guest);
        phoneListView = (ListView) findViewById(R.id.phoneList);
        new PhonesActivityGuest.FetchMoviesAsyncTask().execute();
    }
    ...
    private class FetchMoviesAsyncTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PhonesActivityGuest.this);
    ...
    private void populatePhoneList() {
        ListAdapter adapter = new SimpleAdapter(
                PhonesActivityGuest.this, phoneList,
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                    ...
                    Intent intent = new Intent(getApplicationContext(),
                            PhoneActivityDetailGuest.class);
                    intent.putExtra(KEY_PRODUCT_ID, phoneId);
                    startActivityForResult(intent, 20);

                } else {
                    Toast.makeText(PhonesActivityGuest.this,
